...
public class EtraFPSUsableItemManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (inventory != null) HUDInventory = inventory.GetComponent<SelectedItem>();
    ...
    void instatiateItemAtStart()
    {
        ...
        if (HUDInventory != null) HUDInventory.SelecteSlot(activeItemNum);
    }
