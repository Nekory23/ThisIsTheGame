...
namespace StarterAssets
{
    public class StarterAssetsInputs : MonoBehaviour
    {
        ...
        public void OnShowItemWheel(InputValue value)
        {
            ShowItemWheelInput(value.isPressed);
        }
	...
	// old input system support
        ...
        void Update()
        {
            ...
            */
            ...
            if (Input.GetKeyDown(KeyCode.Escape)) { PauseGameInput(true); }
        ...
        public void ShowItemWheelInput(bool newShowItemWheelState)
        {
            showItemWheel = newShowItemWheelState;
        }
